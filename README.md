...
- `npm run prepare:v1` and `npm run build` pass as of 2026-06-16.
...
doc/                 Planning, tracker, and project review docs
...
- `doc/project-overview.md`: current project overview, optimization review, and recommended next steps.
...
5. Decide whether v1 progress remains single-user local SQLite or gets an explicit user/account boundary before any cloud deployment work.
